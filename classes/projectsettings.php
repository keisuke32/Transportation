...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("tbl_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tbl_uom_type" ] = array( "url" => "tbl_uom_type", "type" => 0 );
	$projectEntitiesReverse[ "tbl_uom_type" ] = "tbl_uom_type";
	$projectEntities[ "tbl_uom" ] = array( "url" => "tbl_uom", "type" => 0 );
	$projectEntitiesReverse[ "tbl_uom" ] = "tbl_uom";
	$projectEntities[ "tbl_sale_terms" ] = array( "url" => "tbl_sale_terms", "type" => 0 );
	$projectEntitiesReverse[ "tbl_sale_terms" ] = "tbl_sale_terms";
	$projectEntities[ "tbl_payment_terms" ] = array( "url" => "tbl_payment_terms", "type" => 0 );
	$projectEntitiesReverse[ "tbl_payment_terms" ] = "tbl_payment_terms";
	$projectEntities[ "tbl_pallet_type" ] = array( "url" => "tbl_pallet_type", "type" => 0 );
	$projectEntitiesReverse[ "tbl_pallet_type" ] = "tbl_pallet_type";
	$projectEntities[ "tbl_address_type" ] = array( "url" => "tbl_address_type", "type" => 0 );
	$projectEntitiesReverse[ "tbl_address_type" ] = "tbl_address_type";
	$projectEntities[ "tbl_country" ] = array( "url" => "tbl_country", "type" => 0 );
	$projectEntitiesReverse[ "tbl_country" ] = "tbl_country";
	$projectEntities[ "tbl_currency" ] = array( "url" => "tbl_currency", "type" => 0 );
	$projectEntitiesReverse[ "tbl_currency" ] = "tbl_currency";
	$projectEntities[ "tbl_province" ] = array( "url" => "tbl_province", "type" => 0 );
	$projectEntitiesReverse[ "tbl_province" ] = "tbl_province";
	$projectEntities[ "tbl_currency_daily_rate" ] = array( "url" => "tbl_currency_daily_rate", "type" => 0 );
	$projectEntitiesReverse[ "tbl_currency_daily_rate" ] = "tbl_currency_daily_rate";
	...
	$projectEntities[ "tbl_address" ] = array( "url" => "tbl_address", "type" => 0 );
	$projectEntitiesReverse[ "tbl_address" ] = "tbl_address";
	$projectEntities[ "tbl_invoices" ] = array( "url" => "tbl_invoices", "type" => 0 );
	$projectEntitiesReverse[ "tbl_invoices" ] = "tbl_invoices";
	$projectEntities[ "tbl_invoice_payments" ] = array( "url" => "tbl_invoice_payments", "type" => 0 );
	$projectEntitiesReverse[ "tbl_invoice_payments" ] = "tbl_invoice_payments";
	$projectEntities[ "tbl_documents" ] = array( "url" => "tbl_documents", "type" => 0 );
	$projectEntitiesReverse[ "tbl_documents" ] = "tbl_documents";
	$projectEntities[ "tbl_equipment" ] = array( "url" => "tbl_equipment", "type" => 0 );
	$projectEntitiesReverse[ "tbl_equipment" ] = "tbl_equipment";
	$projectEntities[ "tbl_equipment_assignment" ] = array( "url" => "tbl_equipment_assignment", "type" => 0 );
	$projectEntitiesReverse[ "tbl_equipment_assignment" ] = "tbl_equipment_assignment";
	$projectEntities[ "tbl_equipment_type" ] = array( "url" => "tbl_equipment_type", "type" => 0 );
	$projectEntitiesReverse[ "tbl_equipment_type" ] = "tbl_equipment_type";
	$projectEntities[ "tbl_lane" ] = array( "url" => "tbl_lane", "type" => 0 );
	$projectEntitiesReverse[ "tbl_lane" ] = "tbl_lane";
	$projectEntities[ "tbl_order_assesorial" ] = array( "url" => "tbl_order_assesorial", "type" => 0 );
	$projectEntitiesReverse[ "tbl_order_assesorial" ] = "tbl_order_assesorial";
	$projectEntities[ "tbl_order_items" ] = array( "url" => "tbl_order_items", "type" => 0 );
	$projectEntitiesReverse[ "tbl_order_items" ] = "tbl_order_items";
	$projectEntities[ "tbl_order_status" ] = array( "url" => "tbl_order_status", "type" => 0 );
	$projectEntitiesReverse[ "tbl_order_status" ] = "tbl_order_status";
	$projectEntities[ "tbl_orders" ] = array( "url" => "tbl_orders", "type" => 0 );
	$projectEntitiesReverse[ "tbl_orders" ] = "tbl_orders";
	$projectEntities[ "tb_activities_type" ] = array( "url" => "tb_activities_type", "type" => 0 );
	$projectEntitiesReverse[ "tb_activities_type" ] = "tb_activities_type";
	$projectEntities[ "tb_contacts_emails" ] = array( "url" => "tb_contacts_emails", "type" => 0 );
	$projectEntitiesReverse[ "tb_contacts_emails" ] = "tb_contacts_emails";
	$projectEntities[ "tb_contacts_phones" ] = array( "url" => "tb_contacts_phones", "type" => 0 );
	$projectEntitiesReverse[ "tb_contacts_phones" ] = "tb_contacts_phones";
	$projectEntities[ "tb_lead_source" ] = array( "url" => "tb_lead_source", "type" => 0 );
	$projectEntitiesReverse[ "tb_lead_source" ] = "tb_lead_source";
	$projectEntities[ "tbl_company" ] = array( "url" => "tbl_company", "type" => 0 );
	$projectEntitiesReverse[ "tbl_company" ] = "tbl_company";
	$projectEntities[ "tbl_credit_approval_Status" ] = array( "url" => "tbl_credit_approval_status", "type" => 0 );
	$projectEntitiesReverse[ "tbl_credit_approval_status" ] = "tbl_credit_approval_Status";
	$projectEntities[ "tb_contacts" ] = array( "url" => "tb_contacts", "type" => 0 );
	$projectEntitiesReverse[ "tb_contacts" ] = "tb_contacts";
	$projectEntities[ "tbl_city" ] = array( "url" => "tbl_city", "type" => 0 );
	$projectEntitiesReverse[ "tbl_city" ] = "tbl_city";
	$projectEntities[ "tbl_county" ] = array( "url" => "tbl_county", "type" => 0 );
	$projectEntitiesReverse[ "tbl_county" ] = "tbl_county";
	...
	$projectEntities[ "targettransportation104_v1_audit" ] = array( "url" => "targettransportation104_v1_audit", "type" => 0 );
	$projectEntitiesReverse[ "targettransportation104_v1_audit" ] = "targettransportation104_v1_audit";
	$projectEntities[ "tbl_company_equipment" ] = array( "url" => "tbl_company_equipment", "type" => 0 );
	$projectEntitiesReverse[ "tbl_company_equipment" ] = "tbl_company_equipment";
	$projectEntities[ "tbl_company_areas" ] = array( "url" => "tbl_company_areas1", "type" => 0 );
	$projectEntitiesReverse[ "tbl_company_areas1" ] = "tbl_company_areas";
	$projectEntities[ "tbl_uomWeight" ] = array( "url" => "tbl_uomweight", "type" => 1 );
	$projectEntitiesReverse[ "tbl_uomweight" ] = "tbl_uomWeight";
	$projectEntities[ "tbl_uomHandling" ] = array( "url" => "tbl_uomhandling", "type" => 1 );
	$projectEntitiesReverse[ "tbl_uomhandling" ] = "tbl_uomHandling";
	$projectEntities[ "tbl_uomPackaging" ] = array( "url" => "tbl_uompackaging", "type" => 1 );
	$projectEntitiesReverse[ "tbl_uompackaging" ] = "tbl_uomPackaging";
	$projectEntities[ "tbl_rfqs" ] = array( "url" => "tbl_rfqs", "type" => 0 );
	$projectEntitiesReverse[ "tbl_rfqs" ] = "tbl_rfqs";
	$projectEntities[ "tbl_rfq_items" ] = array( "url" => "tbl_rfq_items", "type" => 0 );
	$projectEntitiesReverse[ "tbl_rfq_items" ] = "tbl_rfq_items";
	$projectEntities[ "tbl_rfq_assesorial" ] = array( "url" => "tbl_rfq_assesorial", "type" => 0 );
	$projectEntitiesReverse[ "tbl_rfq_assesorial" ] = "tbl_rfq_assesorial";
	$projectEntities[ "tbl_address1" ] = array( "url" => "tbl_address1", "type" => 1 );
	$projectEntitiesReverse[ "tbl_address1" ] = "tbl_address1";
	$projectEntities[ "tbl_rfq_carrier_quote" ] = array( "url" => "tbl_rfq_carrier_quote", "type" => 0 );
	$projectEntitiesReverse[ "tbl_rfq_carrier_quote" ] = "tbl_rfq_carrier_quote";
	$projectEntities[ "tbl_rfq_status" ] = array( "url" => "tbl_rfq_status", "type" => 0 );
	$projectEntitiesReverse[ "tbl_rfq_status" ] = "tbl_rfq_status";
	$projectEntities[ "vw_company_addressbook" ] = array( "url" => "vw_company_addressbook", "type" => 0 );
	$projectEntitiesReverse[ "vw_company_addressbook" ] = "vw_company_addressbook";
	$projectEntities[ "vw_contacts" ] = array( "url" => "vw_contacts", "type" => 1 );
	$projectEntitiesReverse[ "vw_contacts" ] = "vw_contacts";
	$projectEntities[ "formfields" ] = array( "url" => "formfields1", "type" => 0 );
	$projectEntitiesReverse[ "formfields1" ] = "formfields";
	$projectEntities[ "forms" ] = array( "url" => "forms1", "type" => 0 );
	$projectEntitiesReverse[ "forms1" ] = "forms";
	$projectEntities[ "test" ] = array( "url" => "test", "type" => 0 );
	$projectEntitiesReverse[ "test" ] = "test";
	$projectEntities[ "sqlfields" ] = array( "url" => "sqlfields1", "type" => 0 );
	$projectEntitiesReverse[ "sqlfields1" ] = "sqlfields";
	$projectEntities[ "formoptions" ] = array( "url" => "formoptions1", "type" => 0 );
	$projectEntitiesReverse[ "formoptions1" ] = "formoptions";
	$projectEntities[ "vw_rfqs_pdf" ] = array( "url" => "vw_rfqs_pdf", "type" => 0 );
	$projectEntitiesReverse[ "vw_rfqs_pdf" ] = "vw_rfqs_pdf";
	$projectEntities[ "tbl_uomDim" ] = array( "url" => "tbl_uomdim", "type" => 1 );
	$projectEntitiesReverse[ "tbl_uomdim" ] = "tbl_uomDim";
}
