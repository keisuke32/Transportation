...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("tbl_uom_type" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_uom" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_sale_terms" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_payment_terms" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_pallet_type" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_address_type" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_country" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_currency" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_province" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_currency_daily_rate" == $this->chrt_array['tables'][0])
			return true;
		if("targettransportation_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_users" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_address" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_invoices" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_invoice_payments" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_documents" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_equipment" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_equipment_assignment" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_equipment_type" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_lane" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_order_assesorial" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_order_items" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_order_status" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_orders" == $this->chrt_array['tables'][0])
			return true;
		if("tb_activities_type" == $this->chrt_array['tables'][0])
			return true;
		if("tb_contacts_emails" == $this->chrt_array['tables'][0])
			return true;
		if("tb_contacts_phones" == $this->chrt_array['tables'][0])
			return true;
		if("tb_lead_source" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_company" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_credit_approval_Status" == $this->chrt_array['tables'][0])
			return true;
		if("tb_contacts" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_city" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_county" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_users" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_users" == $this->chrt_array['tables'][0])
			return true;
		if("targettransportation104_v1_audit" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_company_equipment" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_company_areas" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_uom" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_uom" == $this->chrt_array['tables'][0])
		...
		if("tbl_uom" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_rfqs" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_rfq_items" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_rfq_assesorial" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_address" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_rfq_carrier_quote" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_rfq_status" == $this->chrt_array['tables'][0])
			return true;
		if("vw_company_addressbook" == $this->chrt_array['tables'][0])
			return true;
		if("tb_contacts" == $this->chrt_array['tables'][0])
			return true;
		if("formfields" == $this->chrt_array['tables'][0])
			return true;
		if("forms" == $this->chrt_array['tables'][0])
			return true;
		if("test" == $this->chrt_array['tables'][0])
			return true;
		if("sqlfields" == $this->chrt_array['tables'][0])
			return true;
		if("formoptions" == $this->chrt_array['tables'][0])
			return true;
		if("vw_rfqs_pdf" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_uom" == $this->chrt_array['tables'][0])
			return true;
		return false;
