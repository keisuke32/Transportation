...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ".
			...
			." from ".
			$grConnection->addTableWrappers( "targettransportation_uggroups" ) .
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "targettransportation_ugrights" )
	...
	function updateTablePermissions( $table, $group, $tableRights )
	{
		...
		$rightWTableName = $this->connection->addTableWrappers( "targettransportation_ugrights" );
