...
function checkTableName($shortTName )
{
	...
	if ("tbl_uom_type" == $shortTName )
		return true;
	if ("tbl_uom" == $shortTName )
		return true;
	if ("tbl_sale_terms" == $shortTName )
		return true;
	if ("tbl_payment_terms" == $shortTName )
		return true;
	if ("tbl_pallet_type" == $shortTName )
		return true;
	if ("tbl_address_type" == $shortTName )
		return true;
	if ("tbl_country" == $shortTName )
		return true;
	if ("tbl_currency" == $shortTName )
		return true;
	if ("tbl_province" == $shortTName )
		return true;
	if ("tbl_currency_daily_rate" == $shortTName )
		return true;
	if ("admin_rights" == $shortTName )
		return true;
	if ("tbl_users" == $shortTName )
		return true;
	if ("tbl_address" == $shortTName )
		return true;
	if ("tbl_invoices" == $shortTName )
		return true;
	if ("tbl_invoice_payments" == $shortTName )
		return true;
	if ("tbl_documents" == $shortTName )
		return true;
	if ("tbl_equipment" == $shortTName )
		return true;
	if ("tbl_equipment_assignment" == $shortTName )
		return true;
	if ("tbl_equipment_type" == $shortTName )
		return true;
	if ("tbl_lane" == $shortTName )
		return true;
	if ("tbl_order_assesorial" == $shortTName )
		return true;
	if ("tbl_order_items" == $shortTName )
		return true;
	if ("tbl_order_status" == $shortTName )
		return true;
	if ("tbl_orders" == $shortTName )
		return true;
	if ("tb_activities_type" == $shortTName )
		return true;
	if ("tb_contacts_emails" == $shortTName )
		return true;
	if ("tb_contacts_phones" == $shortTName )
		return true;
	if ("tb_lead_source" == $shortTName )
		return true;
	if ("tbl_company" == $shortTName )
		return true;
	if ("tbl_credit_approval_status" == $shortTName )
		return true;
	if ("tb_contacts" == $shortTName )
		return true;
	if ("tbl_city" == $shortTName )
		return true;
	if ("tbl_county" == $shortTName )
		return true;
	if ("admin_members" == $shortTName )
		return true;
	if ("admin_users" == $shortTName )
		return true;
	if ("targettransportation104_v1_audit" == $shortTName )
		return true;
	if ("tbl_company_equipment" == $shortTName )
		return true;
	if ("tbl_company_areas1" == $shortTName )
		return true;
	if ("tbl_uomweight" == $shortTName )
		return true;
	if ("tbl_uomhandling" == $shortTName )
		return true;
	if ("tbl_uompackaging" == $shortTName )
		return true;
	if ("tbl_rfqs" == $shortTName )
		return true;
	if ("tbl_rfq_items" == $shortTName )
		return true;
	if ("tbl_rfq_assesorial" == $shortTName )
		return true;
	if ("tbl_address1" == $shortTName )
		return true;
	if ("tbl_rfq_carrier_quote" == $shortTName )
		return true;
	if ("tbl_rfq_status" == $shortTName )
		return true;
	if ("vw_company_addressbook" == $shortTName )
		return true;
	if ("vw_contacts" == $shortTName )
		return true;
	if ("formfields1" == $shortTName )
		return true;
	if ("forms1" == $shortTName )
		return true;
	if ("test" == $shortTName )
		return true;
	if ("sqlfields1" == $shortTName )
		return true;
	if ("formoptions1" == $shortTName )
		return true;
	if ("vw_rfqs_pdf" == $shortTName )
		return true;
	if ("tbl_uomdim" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_uom_type");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_uom");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_sale_terms");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_payment_terms");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_payment_terms";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_pallet_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_address_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_address_type";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_country");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_currency");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_province");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_currency_daily_rate");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_currency_daily_rate";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_address");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_invoices");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_invoice_payments");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_invoice_payments";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_documents");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_equipment");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_equipment_assignment");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_equipment_assignment";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_equipment_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_equipment_type";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_lane");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_order_assesorial");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_order_assesorial";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_order_items");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_order_status");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_order_status";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_orders");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_activities_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tb_activities_type";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_contacts_emails");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tb_contacts_emails";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_contacts_phones");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tb_contacts_phones";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_lead_source");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_company");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_credit_approval_Status");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_credit_approval_Status";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_contacts");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_city");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_county");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("targettransportation104_v1_audit");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="targettransportation104_v1_audit";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_company_equipment");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_company_equipment";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_company_areas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_company_areas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_uomWeight");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_uomHandling");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_uomPackaging");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_uomPackaging";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_rfqs");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_rfq_items");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_rfq_assesorial");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_rfq_assesorial";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_address1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_rfq_carrier_quote");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tbl_rfq_carrier_quote";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_rfq_status");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vw_company_addressbook");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vw_company_addressbook";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vw_contacts");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("formfields");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("forms");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("test");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sqlfields");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("formoptions");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vw_rfqs_pdf");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_uomDim");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="tbl_sale_terms" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_payment_terms" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_pallet_type" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_address_type" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tbl_currency" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_province" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_currency_daily_rate" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tbl_invoices" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_invoice_payments" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tbl_equipment_assignment" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_equipment_type" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tb_activities_type" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tb_contacts_emails" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tb_contacts_phones" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tb_lead_source" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tbl_credit_approval_Status" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tb_contacts" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="targettransportation104_v1_audit" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_company_equipment" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_company_areas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_uomWeight" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_uomHandling" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_uomPackaging" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="tbl_rfq_items" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_rfq_assesorial" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_address1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_rfq_carrier_quote" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_rfq_status" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vw_company_addressbook" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vw_contacts" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="formoptions" )
	{
//	default permissions
		return "".$extraPerm;
	}
	if( $table=="vw_rfqs_pdf" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
function GetBaseScriptsForPage($isDisplayLoading, $additionalScripts = "", $customText = "")
{
	...
	$result = "";
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/loadfirst.js?36520")."\"></script>";


	$result .= $additionalScripts;
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/lang/".getLangFileName(mlang_getcurrentlang()).".js?36520")."\"></script>";
