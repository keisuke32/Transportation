...
$nonAdminTablesArr[] = "tbl_uom_type";
$nonAdminTablesArr[] = "tbl_uom";
$nonAdminTablesArr[] = "tbl_sale_terms";
$nonAdminTablesArr[] = "tbl_payment_terms";
$nonAdminTablesArr[] = "tbl_pallet_type";
$nonAdminTablesArr[] = "tbl_address_type";
$nonAdminTablesArr[] = "tbl_country";
$nonAdminTablesArr[] = "tbl_currency";
$nonAdminTablesArr[] = "tbl_province";
$nonAdminTablesArr[] = "tbl_currency_daily_rate";
$nonAdminTablesArr[] = "tbl_users";
$nonAdminTablesArr[] = "tbl_address";
$nonAdminTablesArr[] = "tbl_invoices";
$nonAdminTablesArr[] = "tbl_invoice_payments";
$nonAdminTablesArr[] = "tbl_documents";
$nonAdminTablesArr[] = "tbl_equipment";
$nonAdminTablesArr[] = "tbl_equipment_assignment";
$nonAdminTablesArr[] = "tbl_equipment_type";
$nonAdminTablesArr[] = "tbl_lane";
$nonAdminTablesArr[] = "tbl_order_assesorial";
$nonAdminTablesArr[] = "tbl_order_items";
$nonAdminTablesArr[] = "tbl_order_status";
$nonAdminTablesArr[] = "tbl_orders";
$nonAdminTablesArr[] = "tb_activities_type";
$nonAdminTablesArr[] = "tb_contacts_emails";
$nonAdminTablesArr[] = "tb_contacts_phones";
$nonAdminTablesArr[] = "tb_lead_source";
$nonAdminTablesArr[] = "tbl_company";
$nonAdminTablesArr[] = "tbl_credit_approval_Status";
$nonAdminTablesArr[] = "tb_contacts";
$nonAdminTablesArr[] = "tbl_city";
$nonAdminTablesArr[] = "tbl_county";
$nonAdminTablesArr[] = "targettransportation104_v1_audit";
$nonAdminTablesArr[] = "tbl_company_equipment";
$nonAdminTablesArr[] = "tbl_company_areas";
$nonAdminTablesArr[] = "tbl_uomWeight";
$nonAdminTablesArr[] = "tbl_uomHandling";
$nonAdminTablesArr[] = "tbl_uomPackaging";
$nonAdminTablesArr[] = "tbl_rfqs";
$nonAdminTablesArr[] = "tbl_rfq_items";
$nonAdminTablesArr[] = "tbl_rfq_assesorial";
$nonAdminTablesArr[] = "tbl_address1";
$nonAdminTablesArr[] = "tbl_rfq_carrier_quote";
$nonAdminTablesArr[] = "tbl_rfq_status";
$nonAdminTablesArr[] = "vw_company_addressbook";
$nonAdminTablesArr[] = "vw_contacts";
$nonAdminTablesArr[] = "formfields";
$nonAdminTablesArr[] = "forms";
$nonAdminTablesArr[] = "test";
$nonAdminTablesArr[] = "sqlfields";
$nonAdminTablesArr[] = "formoptions";
$nonAdminTablesArr[] = "vw_rfqs_pdf";
$nonAdminTablesArr[] = "tbl_uomDim";
...
$wGroupTableName = $ug_connection->addTableWrappers( "targettransportation_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "targettransportation_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "targettransportation_ugrights" );
