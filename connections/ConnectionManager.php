...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "logistics_at_localhost";
		$data["connName"] = "target_transportation at 192.186.240.193";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;192.186.240.193;shipwithtarget;&XC!(MF,Iy8N;;target_transportation;;1"; //currently unused

		$this->_connectionsIdByName["target_transportation at 192.186.240.193"] = "logistics_at_localhost";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "shipwithtarget";
		$data["ODBCPWD"] = "&XC!(MF,Iy8N";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "192.186.240.193";
		$data["connInfo"][1] = "shipwithtarget";
		$data["connInfo"][2] = "&XC!(MF,Iy8N";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "target_transportation";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=192.186.240.193;Uid=shipwithtarget;Pwd=&XC!(MF,Iy8N;Database=target_transportation;OPTION=3";
		// encription set
		...
		$connectionsData["logistics_at_localhost"] = $data;
